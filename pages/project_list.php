...
<section class="content__side">
	...
	<nav class="main-navigation">
		...
		<?php 
			...
			<li class="main-navigation__list-item">
				<a class="main-navigation__list-item-link" href="<?php echo "/index.php?project=".$project[1] ?>"><?php echo $project[1] ?></a>
	...
	<a class="button button--transparent button--plus content__side-button"
		href="<?php echo '/pages/form-project.php' ?>" target="project_add">Добавить проект</a>
</section>
